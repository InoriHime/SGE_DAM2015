...
public class Documento  implements java.io.Serializable {
    ...
    public Documento(Cliente cliente, Proveedor proveedor, String tipo, String fechaPedido, double base, double iva, double total) {
    ...
    public Documento(Cliente cliente, Proveedor proveedor, String tipo, String fechaPedido, double base, double iva, double total, Set articuloPedidos, Set cobros) {
       this.cliente = cliente;
       this.proveedor = proveedor;
       this.tipo = tipo;
       this.fechaPedido = fechaPedido;
